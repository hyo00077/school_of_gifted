...
<p>
    	감각미디어 트랙의 경우, 학생들의 성향과 관심 분야를 경험할 수 있도록, 사운드, 움직임, 글쓰기, 게임 만들기 등 여러 분야의 활동으로 구성됩니다. 1학기는 미디어의 관점에서 각각의 감각 요소의 흐름을 경험하고 글쓰기와 목소리로 번역하고 표현하는 수업이며, 2학기에는 전체 학기의 테마를 정하고 해당 테마에 대한 창작의 재료와 자료를 수집하며, 그것을 다양한 표현 방식으로 다루어 보고 발전시키는 탐색의 과정을 거친다.
