...
<p>
    	‘파운데이션 과정’이 끝나면, 두 개의 트랙으로 학생들을 나눠 영상트랙의 경우, 1학기 15주는 영상 제작에 필요한 기본적인 개념을 체화한 후, 각자의 에세이 영화를 만드는 것으로 활동을 마무리 합니다.  2학기는 쇼트와 콘티뉴이티, 몽타주의 개념 파악을 시작으로 촬영 및 편집, 사운드 디자인 등에 대한 실습을 통해 최종 작품을 만드는 것을 목표로 합니다. 

</p>    
<p>
    	감각미디어 트랙의 경우, 학생들의 성향과 관심 분야를 경험할 수 있도록, 사운드, 움직임, 글쓰기, 게임 만들기 등 여러 분야의 활동으로 구성됩니다. 1학기는 미디어의 관점에서 각각의 감각 요소의 흐름을 경험하고 글쓰기와 목소리로 번역하고 표현하는 수업이며, 2학기에는 전체 학기의 테마를 정하고 해당 테마에 대한 창작의 재료와 자료를 수집하며, 그것을 다양한 표현 방식으로 다루어 보고 발전시키는 탐색의 과정을 거칩니다.
